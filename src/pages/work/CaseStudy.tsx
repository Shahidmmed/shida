      ...
      {project ? (
        <section className="mx-auto">
          ...
          <Tabs defaultValue="defining" className="w-full">
            <TabsList className="grid w-full grid-cols-5 px-16 mb-14">
            ...
            <TabsContent value="developing">
              ...
              <div className="px-16 max-w-[1220px] mx-auto py-14">
                ...
                <p className="pt-8">
                  ...
                  core functions of recording a sale and generating invoices on
                  our app. It's important to note that the app is primarily
                  designed for viewing/tracking information rather than
                  fulfilling actions. Therefore, this user flow, which focuses
                  on sales and invoices, stands as the most significant journey
                  within the app.
                </p>
                <div>Image</div>
                <p>
                  Every design decision is meticulously tailored to enhance user
            ...
            <TabsContent value="clarity">
              <div className="px-16 max-w-[1220px] mx-auto py-14">
                ...
                <ul className="pt-8 font-avant-garde text-base font-light leading-6 list-disc ml-8">
                  <li className="mb-6">
                    ...
                    before, It also required a lot of iterations and research. I
                    used ✨ Figma✨ to get into specific details, better spacing
                    and alignment, and to add more clarity to my sketches. I
                    also prototype key parts and interactions during this
                    process because I find it very effective. (I like to see
                    what I'm doing in real-time to validate the user
                    experience.)
                  </li>
                  <li className="mb-6">
                    I presented my wireframes to my technical lead and project
                    lead to get validation on the general flow and placement of
                    elements. I made sure to ask a lot of questions to make sure
                    we were on the same page and requested modifications (this
                    happened a couple of times) before the visual design phase
                    started.
                  </li>
                </ul>
              </div>
              <div className="px-16 max-w-[1220px] mx-auto py-14">
                ...
                <ul className="pt-8 font-avant-garde text-base font-light leading-6 list-disc ml-8">
                  <li className="mb-6">
                    I used a week to create digital representations of my paper
                    sketches with a few changes and add ons and another week to
                    complete my modifications and complete my design.
                  </li>
                  <li className="mb-6">
            ...
            <TabsContent value="design">
              <div className="px-16 max-w-[1220px] mx-auto py-14">
                ...
                <p className="pt-8">
                  As a budding UX professional, my expertise lies in structuring
                  and organising digital content and interactions to ensure my
                  ideas are organised into key sections and functionalities. The
                  mockups below represent the approved designs by business
                  before testing.
                </p>
              ...
              <div className="px-16 max-w-[1220px] mx-auto py-14">
                ...
                <p className="pt-8">
                  This was a cool and interesting project to work on. It was an
                  exciting challenge that pushed me to new heights. It taught me
                  the essence of collaboration, and the iterative process
                  highlighted the importance of adaptability within design.
                  Through this project, I learned that the most efficient design
                  processes are those that flex and adapt to the unique needs of
                  each project. #WiseWordsFr
                </p>
              </div>
            ...
            <TabsContent value="guide">
              <div className="px-16 max-w-[1220px] mx-auto py-14">
                ...
                <p className="pt-8">
                  I was inspired by the design system for the desktop & web app
                  to create my style guide for the mobile app to deliver a clear
                  and consistent design solution. Predominantly purple and green
                  screens would provide a sense of calm and control; simple
                  button states and clear iconography would help make tasks feel
              ...
              <div className="px-16 max-w-[1220px] mx-auto py-14">
                ...
                <p className="pt-8">
                  ...
                  fits perfectly with the project's objectives. I wanted to use
                  a font that was modern, versatile and legible across various
                  screen sizes and resolutions while also creating a sense of
                  professionalism.
                </p>
              </div>
            </TabsContent>
