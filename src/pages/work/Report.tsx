      ...
      {project ? (
        <section className="mx-auto">
          ...
          <div className="px-16 max-w-[1220px] mx-auto py-14">
            ...
            <p className="py-8">
              Leads is a software solution designed to help businesses organise
              and manage their sales leads throughout the customer acquisition
              process. It typically includes tools for capturing, storing and
              tracking interactions with potential customers and analysing the
              data received to help sales and marketing teams make informed
              decisions. The system allows businesses to streamline their sales
              processes, increase efficiency, improve lead conversion rates, and
              ultimately boost customer relations.
            </p>
            <div className="mt-2">
              <Link
                to="#"
          ...
          <div className="px-16 max-w-[1220px] mx-auto py-14">
            ...
            <p className="py-8">
              ...
              interface and its processes. Each session lasted approximately 5-7
              minutes. Participants were given the same tasks to complete and
              questions to answer. All participants generally found the product
              user-friendly, easy to navigate and straightforward.
            </p>
          </div>
          ...
          <div className="px-16 max-w-[1220px] mx-auto py-14">
            ...
            <ul className="pt-8 font-avant-garde text-base font-light leading-6 list-disc ml-8">
              <li className="mb-6 list-lower-alpha">
                A moderated usability study with a total of 6 participants with
                backgrounds in business, sales and marketing. Participants were
                asked to perform tasks in a high-fidelity prototype. Each
                session lasted between 5-7 minutes.
              </li>
              <li className="mb-6 list-lower-alpha">
              ...
              <li className="mb-6 list-lower-alpha">
                ...
                through a survey. In the end, a usability scale questionnaire of
                10 questions was sent to participants to complete.
              </li>
              <li className="mb-6 list-lower-alpha">
          ...
          <div className="px-16 max-w-[1220px] mx-auto py-14">
            ...
            <p className="py-8">
              I chose to use the System Usability Scale and Conversion Rate KPIs
              to translate the success factors of my usability test into actual
              figures because they're close to my research goals. I used a
              standardised questionnaire to measure my product's perceived
              usability.
            </p>
          </div>
          <div className="px-16 max-w-[1220px] mx-auto py-14">
            ...
            <p className="pt-8">
              ...
              Participants completed their tasks independently, and I only spoke
              when help was needed or when it was time to give a new task during
              the test.
            </p>
            <ul className="pt-8 font-avant-garde text-base font-light leading-6 list-disc ml-8">
              <li className="mb-6 list-lower-alpha">
              ...
              <li className="mb-6 pb-4 list-lower-alpha">
                System Usability Scale- How easy the app is for the user through
          ...
          <div className="px-16 max-w-[1220px] mx-auto py-14">
            ...
            <p className="pt-8">
              To sum up the data collection, I asked a few questions at the end
              of the session to gather information on the product's overall
              effectiveness, observations and commentary in relation to the
              goals of each task. I allowed participants to speak their minds
            ...
            <ul className="pt-8 font-avant-garde text-base font-light leading-6 list-disc ml-8">
              ...
              <li className="mb-6 list-lower-alpha">
                What other comments do you have? Do you have any suggestions for
                improvement?
              </li>
            </ul>
          </div>
          <div className="px-16 max-w-[1220px] mx-auto py-14">
            ...
            <ul className="pt-8 font-avant-garde text-base font-light leading-6 list-disc ml-8">
              ...
              <li className="mb-6 list-lower-alpha">
                ...
                questions in detail after every task was performed. The last two
                participated in a face-to-face test.
              </li>
            </ul>
          ...
          <div className="px-16 max-w-[1220px] mx-auto py-14">
            ...
            <p className="py-8">
              After the test, i compiled and summarised the data collected using
              the card sorting method to group my insights and build effectively
              toward next steps.
            </p>
            <div className="pt-8">
              ...
              <div className="grid flex-1 items-start gap-4 py-4 sm:py-6 md:gap-8 lg:grid-cols-3 xl:grid-cols-3">
                ...
                <Card className="w-[300px] h-[145px] bg-blue-200 rounded-none flex flex-col items-center justify-center">
                  ...
                  <p className="text-center">
                    Toggling between some tabs was a bit slow. Eg from Contacts
                    to People.
                  </p>
                </Card>
                <Card className="w-[300px] h-[145px] bg-blue-200 rounded-none flex flex-col items-center justify-center">
          ...
          <div className="px-16 max-w-[1220px] mx-auto py-14">
            ...
            <p className="pt-8 font-avant-garde">
              ...
              implemented immediately because they focused more on improving the
              product's user experience and what does not work well for users.
            </p>
            <div>Image</div>
          </div>
          <div className="px-16 max-w-[1220px] mx-auto py-14">
          ...
          <div className="px-16 max-w-[1220px] mx-auto py-14">
            ...
            <ul className="pt-8 font-avant-garde text-base font-light leading-6 list-disc ml-8">
              <li className="mb-6 list-lower-alpha">
                Based on the feedback from the usability test and the SUS data,
                it can be concluded that the Leads management system I designed
                has a logical user flow with an overall good user interface. The
                product was comprehensible and usable to most participants, with
                a high conversion rate. However, some areas needed improvement,
                particularly with the contacts and leads features and some user
