  ...
  return (
    <div className="xl2:w-[1240px] w-[1100px] mx-auto px-12 max-sm:w-full max-sm:px-8">
      <div className="mx-auto flex items-left flex-col justify-center py-10">
        <p className="appear-on-scroll font-light max-sm:font-normal text-[#484A56] md:max-xl:text-base max-sm:text-xs text-xl tracking-wide max-sm:tracking-wide pb-6">
        ...
        <div className="appear-on-scroll">
          <p className="text-[#484A56] font-light md:max-xl:text-base text-xl max-sm:text-wrap max-sm:text-xs max-sm:tracking-wide tracking-wide pt-6">
