        ...
        <div className="max-w-[1220px] px-16 max-sm:px-8 mx-auto">
          ...
          <div className="appear-on-scroll flex max-sm:flex-col-reverse work-container justify-between">
            <div className="max-w-[558px] mr-4">
              <p className="max-sm:hidden text-xl font-light leading-relaxed tracking-wide max-sm:text-base text-left">
              ...
              <Button className="max-sm:hidden rounded-none bg-black hover:bg-slate-800/80 text-base text-white px-20 py-8 border mt-6">
                My Resume
              </Button>
            </div>
        ...
        <div className="appear-on-scroll max-sm:px-8 max-sm:text-wrap sm:flex max-w-[1200px] w-[1120px] max-sm:w-full max-sm:pt-8 px-2 mx-auto justify-between items-center pt-12">
          <div className="max-sm:flex max-sm:items-center max-sm:pb-4">
            ...
            <img
              src={kite}
              alt="orange kite"
              className="sm:hidden h-10 max-sm:h-8"
            />
          </div>
          <img
            src={kite}
        ...
        <div className="appear-on-scroll font-avant-garde py-8 max-w-[1220px] px-10 mx-auto">
          <div className="flex max-sm:flex-col justify-evenly max-sm:pb-0 py-8">
            <div className="flex mb-6 w-[220px]">
              <div>
                <p className="text-xl max-sm:text-base font-light text-nowrap leading-relaxed tracking-wide">
                  Nana Yaw Kunale
                </p>
            ...
            <p className="text-xl max-sm:text-base font-light leading-relaxed tracking-wide mb-4 max-w-[900px]">
          ...
          <div className="appear-on-scroll flex max-sm:flex-col  max-sm:pb-0 justify-evenly py-8">
            <div className="flex mb-6 w-[220px]">
              <div>
                <p className="text-xl max-sm:text-base font-light text-nowrap leading-relaxed tracking-wide">
                  Ummul-Khair Zurak
          ...
          <div className="appear-on-scroll flex max-sm:flex-col max-sm:pb-0 justify-evenly py-8">
            <div className="flex mb-6 w-[220px]">
              <div>
                ...
                <p className="text-xs position font-light leading-relaxed tracking-wide">
                  Product Owner
                </p>
              </div>
            </div>
