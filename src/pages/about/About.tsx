    ...
    <div className="pt-20 max-sm:pt-8">
      <section className="pb-16 max-sm:pb-8">
        <div className="max-w-[1220px] px-16 max-sm:px-8 mx-auto">
          ...
          <div className="appear-on-scroll flex max-sm:flex-col-reverse work-container justify-between">
            <div className="max-w-[558px] mr-4">
              <p className="text-xl font-light leading-relaxed tracking-wide max-sm:text-base text-left">
        ...
        <div className="appear-on-scroll flex max-w-[1200px] w-[1120px] max-sm:w-full max-sm:pt-8 px-2 mx-auto justify-between items-center pt-12">
          <p className="avant-garde-bold font-bold text-6xl max-sm:text-xl text-black leading-none ">
            Innovation
          </p>
          <img src={kite} alt="orange kite" className="h-10 max-sm:h-5" />
          <p className="avant-garde-bold font-bold text-6xl max-sm:text-xl text-white leading-none  border-black">
            Strategy
          </p>
          <img src={kite2} alt="green kite" className="h-10 max-sm:h-5" />
          <p className="avant-garde-bold font-bold text-6xl max-sm:text-xl text-black leading-none ">
            Design
          </p>
        </div>
      ...
      <section className="py-10 bg-black text-white flex items-center max-sm:w-full max-sm:py-8 flex-col justify-center mx-auto">
        <div className="space-y-12 max-w-[1220px] px-16 max-sm:px-8">
          <div className="appear-on-scroll">
            <h3 className="font-avant-garde text-4xl max-sm:text-3xl font-bold tracking-wider leading-14 mb-6">
              Areas of expertise
            </h3>
      ...
      <section className="py-12 px-16 mx-auto max-sm:w-full max-sm:px-2">
        ...
        <div className="appear-on-scroll font-avant-garde py-8 max-w-[1220px] px-10 mx-auto">
          <div className="flex max-sm:flex-col justify-evenly py-8">
            <div className="flex mb-6 w-[220px]">
              ...
              <span className="sm:hidden text-2xl font-bold ml-4 mr-6 avant-garde-bold">
                :
              </span>
            </div>
            <span className="max-sm:hidden text-3xl font-bold ml-2 mr-6 avant-garde-bold">
              :
            </span>
          ...
          <div className="appear-on-scroll flex max-sm:flex-col justify-evenly py-8">
            <div className="flex mb-6 w-[220px]">
              <div>
                <p className="text-xl font-light text-nowrap leading-relaxed tracking-wide">
                  Ummul-Khair Zurak
